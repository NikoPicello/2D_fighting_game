...
public class HandleAnimations : MonoBehaviour
{
    ...
    public AttackBase[] attacks = new AttackBase[3]; 
    ...
    void FixedUpdate()
    {
        ...
        if (states.vertical < 0) states.crouch = true;
        else states.crouch = false; 
    ...
    void HandleAttacks()
    {
        if (states.canAttack){
            ...
            if (attacks[0].attack){
                ...
                // timesPressed is to avoid the situation in which somebody is holding the attack button, if he holds it for more than 3 frames then he attacks again
            ...
            if (attacks[1].attack){
                ...
                if (attacks[1].attackTimer > attackRate || attacks[1].timesPressed >= 2){
                    attacks[1].attackTimer = 0; 
            ...
            if (attacks[2].attack){
                ...
                if (attacks[2].attackTimer > attackRate || attacks[2].timesPressed >= 5){
                    attacks[2].attackTimer = 0; 
        ...
        anim.SetBool("Kick", attacks[2].attack);
    }
